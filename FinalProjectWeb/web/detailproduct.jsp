...
//            }
            ...
            TypeProduct tp = (TypeProduct) request.getAttribute("type");
...
<!--        <h1> <%=p.getTp()%> </h1>-->
        ...
        <div class="container" style="margin-top: 30px;">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="background-color: white">
                    <img src="<%=p.getImage()%>" style="height: 250px; width: 250px; left: 55px;top: 20px; position: relative;">                           
                </div>
                <div class="col-md-6">	
                    <h4>Tên sản phẩm <%=p.getName()%></h5>
                        <p>Giá bán: 19000000</p>
                        <p>Loại sp: <%=tp.getName()%></p>
                        <p>Tình trạng: Còn hàng</p>
                        <% if (cs == null) {%>
                        <button type="button" onclick="myFunction()">Mua hàng</button>
                        <%} else {%>
                        <a href="InsertOrder?username=<%=cs.getUsername()%>&productId=<%=p.getId()%>">
        ...
        <script>
            function myFunction() {
            <% if (cs == null) { %>
                document.getElementById("notification").innerHTML = "Bạn cần phải đăng nhập để mua hàng";
            <% } else {%>
                window.location.href = "InsertOrder?username=<%=cs.getUsername()%>&productId=<%=p.getId()%>";
            <% }%>
            }
        </script>
