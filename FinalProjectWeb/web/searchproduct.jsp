...
<html>
    <head>
        ...
        <%
            ...
            boolean check = false;
            ArrayList<Product> psearch = (ArrayList<Product>) request.getAttribute("pdsearch");
            if (psearch != null) {
                check = true;
            }
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                            <div class="navbar-nav">
                                                <a class="nav-item nav-link active" href="Homepage">Trang chủ<span class="sr-only">(current)</span></a>
                ...
                <div class="col-md-12">
                    <div class="product-home-title" style="margin-bottom: 10px">
                        <div class="title-product">
                            <% if (psearch.size() != 0) {%>
                            <h3>Kết quả phù hợp với <%=nameSearch%></h3>
                            <%} else {%>
