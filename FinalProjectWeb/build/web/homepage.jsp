...
<html>
    <head>
        ...
        <%
            ArrayList<Product> listApple = (ArrayList<Product>) request.getAttribute("apple");
            ArrayList<Product> listSamsung = (ArrayList<Product>) request.getAttribute("samsung");
            ArrayList<Product> listOppo = (ArrayList<Product>) request.getAttribute("oppo");
            ArrayList<Product> listHuawei = (ArrayList<Product>) request.getAttribute("huawei");
            ArrayList<Product> listXiaomi = (ArrayList<Product>) request.getAttribute("xiaomi");
            ArrayList<Product> listVivo = (ArrayList<Product>) request.getAttribute("vivo");
            ArrayList<Product> listIpad = (ArrayList<Product>) request.getAttribute("ipad");
            ArrayList<Product> listAcess = (ArrayList<Product>) request.getAttribute("access");
